...
namespace recieverpakket
{
    ...
    {
        [JsonProperty("A")]
        public LightNormalLanemsg A
        {
            get; set;
        }

        [JsonProperty("B")]
        public LightFullLanemsg B
        {
            get; set;
        }

        [JsonProperty("C")]
        public LightCarLanemsg C
        {
            get; set;
        }
    }
    ...
    {
        [JsonProperty("D")]
        public LightCarLanemsg D
        {
            get; set;
        }

        [JsonProperty("E")]
        public LightFullLanemsg E
        {
            get; set;
        }

        [JsonProperty("F")]
        public LightNormalLanemsg F
        {
            get; set;
        }
    }
