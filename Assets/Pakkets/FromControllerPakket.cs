...
public class FromControllerPakket : MonoBehaviour
{
    ...
    {
        [JsonProperty("A")]
        public blockStateFromControl A
        {
            get; set;
        }

        [JsonProperty("B")]
        public blockStateBusFromControl B
        {
            get; set;
        }

        [JsonProperty("C")]
        public blockStateCarOnlyFromControl C
        {
            get; set;
        }

        [JsonProperty("D")]
        public blockStateCarOnlyFromControl D
        {
            get; set;
        }

        [JsonProperty("E")]
        public blockStateBusFromControl E
        {
            get; set;
        }

        [JsonProperty("F")]
        public blockStateFromControl F
        {
            get; set;
        }
    }
    ...
    {
        [JsonProperty("Cars")]
        public List<int> CarLampState
        {
            get; set;
        }

        [JsonProperty("Cyclists")]
        public List<int> BikeLampState
        {
            get; set;
        }

        [JsonProperty("Pedestrians")]
        public List<int> PedestrianLampState
        {
            get; set;
        }
    }
